...
var RemoteController = /** @class */ (function (_super) {
    ...
    RemoteController.prototype.updatedTargetConfiguration = function () {
        ...
        var bufferList = [];
        try {
            for (var _c = (0, tslib_1.__values)(Object.values(this.targetConfigurations)), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                try {
                    for (var _e = (e_4 = void 0, (0, tslib_1.__values)(configuration.buttonConfiguration.values())), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var value = _f.value;
